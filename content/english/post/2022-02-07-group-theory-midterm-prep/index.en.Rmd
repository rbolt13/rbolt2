...
Notes are on sets, subsets, operations, commutative, associative, identity, inverses, groups, abelian groups, cancellation law, propositions and theorems on group, subgroups, functions, injective, surjective, bijective, permutation, symmetric groups, cycles, cycle decomposition, disjoint cycles, inverse of a cycle, length and transposition, Transposition Parity Theorem, isomorphisms, and Cayley's Theorem. 
